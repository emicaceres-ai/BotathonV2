    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <section aria-label="Indicadores Clave">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Total Voluntarios */}
          <div className={`relative p-6 rounded-xl shadow-sm border transition-all duration-200 overflow-hidden ${
            isHighContrast ? 'bg-black border-white' : 'bg-white border-gray-100 hover:shadow-md'
          }`}>
          ...
          <div className={`relative p-6 rounded-xl shadow-sm border transition-all duration-200 overflow-hidden ${
            ...
            <div className={`absolute top-0 left-0 w-full h-1 ${isHighContrast ? 'bg-white' : 'bg-orange-500'}`}></div>
            <div className="flex justify-between items-start">
              <div>
